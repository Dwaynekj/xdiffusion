...
class QKNorm(torch.nn.Module):
    def __init__(self, dim: int):
        super().__init__()
        self.query_norm = DynamicTanhNorm(dim)
        self.key_norm = DynamicTanhNorm(dim)
...
class DoubleStreamBlock(nn.Module):
    def __init__(
        ...
        self.img_norm1 = DynamicTanhNorm(hidden_size)
        self.img_attn = SelfAttention(
            dim=hidden_size, num_heads=num_heads, qkv_bias=qkv_bias
        )

        self.img_norm2 = DynamicTanhNorm(hidden_size)
        ...
        self.txt_norm1 = DynamicTanhNorm(hidden_size)
        self.txt_attn = SelfAttention(
            dim=hidden_size, num_heads=num_heads, qkv_bias=qkv_bias
        )

        self.txt_norm2 = DynamicTanhNorm(hidden_size)
...
class SingleStreamBlock(nn.Module):
    ...
    def __init__(
        ...
        self.hidden_size = hidden_size
        self.pre_norm = DynamicTanhNorm(hidden_size)

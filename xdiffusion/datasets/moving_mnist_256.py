...
class MovingMNIST(Dataset):
    ...
    def __init__(self, root_dir, transform=None):
        ...
        videos_file_name = os.path.join(root_dir, "MovingMNIST256/videos_data.npz")
        labels_file_name = os.path.join(root_dir, "MovingMNIST256/labels_data.npz")

        _VIDEOS_URL = "https://drive.google.com/uc?export=view&id=1fIA4YaFNNYH3Oz6WOoyFdZD4TAvEIlO6"
        _LABELS_URL = "https://drive.google.com/uc?export=view&id=1XPZCf6ft3q6neu1grbfNqeLm30rzy9Da"
        _VIDEOS_FILE_ID = "1fIA4YaFNNYH3Oz6WOoyFdZD4TAvEIlO6"
        _LABELS_FILE_ID = "1XPZCf6ft3q6neu1grbfNqeLm30rzy9Da"
        ...
        self._video_data = torch.from_numpy(
            videos_np.reshape(self._num_videos, 1, self._num_frames_per_video, 256, 256)
        )
